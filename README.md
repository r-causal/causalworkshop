...
[![R-universe
version](https://r-causal.r-universe.dev/causalworkshop/badges/version)](https://r-causal.r-universe.dev/causalworkshop)
<!-- badges: end -->

## Installation

You can install causalworkshop from
...
You can also install the development version of causalworkshop from
[GitHub](https://github.com/r-causal/causalworkshop) with:
